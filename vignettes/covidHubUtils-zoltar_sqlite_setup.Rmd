...
author: "Serena Wang, Matthew Cornell"
...
# Instructions
Loading forecasts from a local zoltar sqlite file requires a special setup. Please follow these steps prior to using this function:
...
covidHubUtils::load_forecasts(
  ...
  zoltar_module_path = "<your_db.sqlite3_dir>")
```
