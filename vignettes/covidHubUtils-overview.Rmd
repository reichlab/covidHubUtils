...
The following snippet of code provides a line graph of the all the models chosen and plots the percentage of coverage inside the interval over a range of intervals. Here is the code for the plot:
```{r}
scores %>%
