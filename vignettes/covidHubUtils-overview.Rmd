...
Here is the data frame returned from these queries. In addition to the essential forecast data, a few columns with location information are also returned.
...
The scores could be used to compare the accuracy and precision of forecasts across models, locations, horizons, and submission weeks. 
