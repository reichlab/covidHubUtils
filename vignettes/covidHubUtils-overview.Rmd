...
```{r}
forecasts_baseline <- load_latest_forecasts(models = "COVIDhub-baseline",
                      last_forecast_date = "2020-12-07",
                      forecast_date_window_size = 6, 
                      locations = "US",
                      types = c("point","quantile"),
                      ...
                      as_of=NULL,
                      hub = c("US"))
scores <- score_forecasts(forecasts = rbind(forecasts,forecasts_baseline),
  return_format = "wide",
  truth = truth_data)
...
You can access the [evaluation paper](https://www.medrxiv.org/content/10.1101/2021.02.03.21250974v1) to read an in depth explaination about the methadologies and you can also visit the [evaluation reports page](https://covid19forecasthub.org/eval-reports/). 
