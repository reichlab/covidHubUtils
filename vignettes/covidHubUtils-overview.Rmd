...
forecasts_multiple <- load_forecasts(
  ...
  dates = as.Date(c("2020-12-14", "2020-12-15")) + seq(0, 35, 7),
  locations = "US",
  types = c("point", "quantile"),
  targets = paste(1:4, "wk ahead inc death"),
  source = "zoltar",
