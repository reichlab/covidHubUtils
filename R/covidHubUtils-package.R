...
##' @description A data frame with information and metadata about national, state, and county locations for the US.
##' @docType data
##' @format A data frame with 3,200 observations on the following 6 variables. 
##' \describe{
